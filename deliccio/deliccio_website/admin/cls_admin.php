...
class clsadmin
{
    ...
    public function Save_Admin()
    {
        ...
        $qry="Call insadmin('$this->name','$pass','$this->type')";    //query to call stored procedure
    ...
    public function Login_Admin()
    {
        ...
        $link=$con->db_connect();       //making a connection
        $pass=md5($this->password);
        $qry="Call loginadmin('$this->name','$pass',@ret)";           //query to call stored procedure
        $res=  mysqli_query($link, $qry);                                       //exceuting the query
        ...
        if($d==1)
        {
            $str="Username and Password are correct";
        }
